...
El sistema permitirá asignar turnos, mantener toda la información de los pacientes, controlar que los turnos se asignen correctamente y administrar las liquidaciones
